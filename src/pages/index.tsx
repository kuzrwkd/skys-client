...
import { set as dataSetForNikkeiNews } from '@/interfaces/presenters/redux/reducers/nikkei/news'
import { set as dataSetForNikkeiMarkets } from '@/interfaces/presenters/redux/reducers/nikkei/markets'
import { set as dataSetForNikkeiTechnology } from '@/interfaces/presenters/redux/reducers/nikkei/technology'
import { set as dataSetForNikkeiBusiness } from '@/interfaces/presenters/redux/reducers/nikkei/business'
import { set as dataSetForNikkeiEconomy } from '@/interfaces/presenters/redux/reducers/nikkei/economy'
import { set as dataSetForReutersBusiness } from '@/interfaces/presenters/redux/reducers/reuters/business'
import { set as dataSetForReutersEconomy } from '@/interfaces/presenters/redux/reducers/reuters/economy'
import { set as dataSetForReutersForex } from '@/interfaces/presenters/redux/reducers/reuters/forex'
import { set as dataSetForReutersOddlynough } from '@/interfaces/presenters/redux/reducers/reuters/oddlynough'
import { set as dataSetForReutersOil } from '@/interfaces/presenters/redux/reducers/reuters/oil'
import { set as dataSetForReutersStock } from '@/interfaces/presenters/redux/reducers/reuters/stock'
import { set as dataSetForReutersTechnology } from '@/interfaces/presenters/redux/reducers/reuters/technology'
import { set as dataSetForReutersTop } from '@/interfaces/presenters/redux/reducers/reuters/top'
import { set as dataSetForReutersWorld } from '@/interfaces/presenters/redux/reducers/reuters/world'
import { set as dataSetBloombergCommentary } from '@/interfaces/presenters/redux/reducers/bloomberg/commentary'
import { set as dataSetBloombergDomestic } from '@/interfaces/presenters/redux/reducers/bloomberg/domestic'
import { set as dataSetBloombergEconomy } from '@/interfaces/presenters/redux/reducers/bloomberg/economy'
import { set as dataSetBloombergMarkets } from '@/interfaces/presenters/redux/reducers/bloomberg/markets'
import { set as dataSetBloombergOverseas } from '@/interfaces/presenters/redux/reducers/bloomberg/overseas'
import { set as dataSetBloombergTop } from '@/interfaces/presenters/redux/reducers/bloomberg/top'
